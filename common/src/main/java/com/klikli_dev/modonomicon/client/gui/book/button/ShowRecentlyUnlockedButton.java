...
public class ShowRecentlyUnlockedButton extends Button {

    private final BookParentScreen parent;
    private final int scissorX;

    public ShowRecentlyUnlockedButton(BookParentScreen parent, int pX, int pY, int scissorX, int width, int height, OnPress pOnPress, Tooltip tooltip) {
