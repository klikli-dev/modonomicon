...
public class GrantFactCommand implements com.mojang.brigadier.Command<CommandSourceStack> {
    ...
    private static final GrantFactCommand CMD = new GrantFactCommand();
    ...
    public int run(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
        ...
        ResearchServices.state().grantFact(player, factId);
        ...
        context.getSource().sendSuccess(() -> Component.translatable(Command.SUCCESS_GRANT_FACT, factId.toString()), true);
        return 1;
    }
}
