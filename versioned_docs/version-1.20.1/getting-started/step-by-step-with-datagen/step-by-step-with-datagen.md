...
You can find the files at **https://github.com/klikli-dev/modonomicon/tree/version/1.20.1/common/src/main/java/com/klikli_dev/modonomicon/datagen/book**
...
The example modonomicon provides, https://github.com/klikli-dev/modonomicon/tree/version/1.20.1/common/src/main/java/com/klikli_dev/modonomicon/datagen/book/DemoBook.java, uses this class to set up the demo book. It is recommended to simply copy this file (or modify it directly).
