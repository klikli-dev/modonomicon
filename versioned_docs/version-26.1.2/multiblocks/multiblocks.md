...
- Further, they can be used to verify if a multiblock is correctly built, allowing you to create custom multiblock machines. See the [MultiblockVerification](https://github.com/klikli-dev/modonomicon/blob/-/common/src/main/java/com/klikli_dev/modonomicon/api/multiblock/MultiblockVerification.java) class and `MultiblockRegistry#checkMultiblock()` for the code API.
