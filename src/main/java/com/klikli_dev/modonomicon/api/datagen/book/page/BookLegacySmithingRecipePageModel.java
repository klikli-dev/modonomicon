...
public class BookLegacySmithingRecipePageModel extends BookRecipePageModel {
    protected BookLegacySmithingRecipePageModel(@NotNull String anchor) {
        super(Page.LEGACY_SMITHING_RECIPE, anchor);
    }
    ...
    public static class Builder extends BookRecipePageModel.Builder<Builder> {
        ...
        public BookLegacySmithingRecipePageModel build() {
            BookLegacySmithingRecipePageModel model = new BookLegacySmithingRecipePageModel(this.anchor);
