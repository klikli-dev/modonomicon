...
/**
 * @param renderSoftLineBreaks True to render soft line breaks (deviating from MD spec).
 *                             Should usually be false.
 * @param replaceSoftLineBreaksWithSpace True to replace soft line breaks with spaces.
